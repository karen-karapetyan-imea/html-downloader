...
#
# Usage:
#   ./scripts/run_weekly.sh saatchi|artsper|artsy|artmajeur|singulart
#
...
marketplace="${1:-}"
case "${marketplace}" in
  saatchi|artsper|artsy|artmajeur|singulart) ;;
  *)
    echo "usage: $0 saatchi|artsper|artsy|artmajeur|singulart" >&2
    exit 2
    ;;
esac
